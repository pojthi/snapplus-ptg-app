...
<html lang="en">
    ...
    <body class="skin-green fixed-layout">    
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <div class="col-md-5 align-self-center">
                            <h4 class="text-themecolor">เพิ่ม ข้อมูล พนักงาน [ ชั่วคราว ] </h4>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">     
                                                ...
                                                <input type="number" id="txtemp_id" name="txtemp_id" maxlength="8" class="form-control" placeholder="รหัสพนักงาน" /> 
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>ชื่อ - นามสกุล</label>
                                                <input type="text" id="txtemp_name" name="txtemp_name" class="form-control" placeholder="ชื่อ - นามสกุล" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>ตำแหน่ง</label>
                                                <input type="text" id="txtpos_name" name="txtpos_name" class="form-control" placeholder="ตำแหน่ง" /> 
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>รหัสตำแหน่ง</label>
                                                <input type="text" id="txtpos_code" name="txtpos_code" class="form-control" placeholder="รหัสตำแหน่ง" readonly /> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>สาขา</label>
                                                <input type="text" id="txtbranch_name" name="txtbranch_name" class="form-control" placeholder="สาขา" /> 
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>รหัสสาขา</label>
                                                <input type="text" id="txtbranch_code" name="txtbranch_code" class="form-control" placeholder="รหัสสาขา" readonly /> 
                                            </div>
                                        </div>
                                    </div>								
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">  
                                                ...
                                                -->
                                                <p onClick="linkTempStaffFromAdd()" id="btnCancel" name="btnCancel" class="btn btn-warning"><i class="far fa-times-circle"></i> ยกเลิก</p>
                                            </div>
                                        </div>
                                    </div>									
                                    </form>
        ...
        function eventClick() {
            ...
            //validate
            if (txtemp_id.length >= 5 && txtpos_code.length > 0 && txtbranch_code.length > 0) {
                $.post("../repository/hr/save-tempstaff.php", {emp_id: txtemp_id,emp_name: txtemp_name,
                pos_code: txtpos_code,pos_name: txtpos_name,branch_code: txtbranch_code,
                branch_name: txtbranch_name,datefrom: txtfromDate,dateto: txttoDate}, function(result){
                    let response = jQuery.parseJSON(result);                
                        ...
                        try {
                            ...
                            Swal.fire({
                                ...
                                text: "มีข้อมูลพนักงานรหัส : " + response.success[0].EMP_ID + " แล้วในระบบ",
                                timer: 10000,
                                showConfirmButton: true,
                                    onClose: () => {
                                    }
