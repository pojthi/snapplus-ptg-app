    ...
    <body class="skin-green fixed-layout">
                        ...
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">การเข้าใช้ระบบ</li>
                                </ol>
        ...
        <script type="text/javascript">
            ...
            function eventExportClick() { 
                ...
                window.location.href = "report-activity-export.php?emp=" + empIdVal + "&sdate=" + fromDate + "&edate=" + toDate + "&roleCode=" + localStorage.getItem('roleCode') + '&fullName=' + localStorage.getItem('empFullname');
            }
