...
var pdfjsWebLibs; {
    ...
    (function() {
        ...
        (function(root, factory) {
            ...
            function configure(PDFJS) {//kratai
                PDFJS.imageResourcesPath = 'plugins/pdfhelper/images/';
                PDFJS.workerSrc = 'plugins/pdfhelper/build/pdf.worker.js';
                PDFJS.cMapUrl = 'plugins/pdfhelper/web/cmaps/';  //'../web/cmaps/';
            ...
            webViewerOpenFileViaURL = function webViewerOpenFileViaURL(file) {
                ...
                if (file) {
						...
						xhr.open('GET', folderFiles+file+".txt", true); //kratai         old .txt               
						xhr.responseType = "text";    //  xhr.responseType = 'text';  / arraybuffer
                        xhr.onload = function(e) {
                      if (this.status == 200) {
                        // PDFViewerApplication.setTitleUsingUrl("hello");
